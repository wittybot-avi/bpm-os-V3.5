...
| **V35-S1-WIZ-SPEC-FIX-02** | Architecture | Step Splitting | **STABLE** | Formalized split between `BASE_SKU_METADATA` and dynamic `SKU_SPEC_REGISTRY`. Consolidated technical input rendering into a single registry-driven step. | 2026-01-28 18:30 (IST) |
